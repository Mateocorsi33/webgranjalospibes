    ...
    return (
        <>
            ...
            <DivCont data-aos="zoom-in">
                ...
                <Parrafo>LAS ENTRADAS PARA VISITAR EL COMPLEJO TIENE UN VALOR GENERAL DE <strong>$2000.</strong>SE PUEDEN ADQUIRIR EN EL MISMO LUGAR, SIN NECESIDAD DE RESERVA PREVIA. <strong>¡ESTACIONAMIENTO LIBRE Y GRATUITO!</strong></Parrafo>
            </DivCont>
            <DivCont data-aos="zoom-in">
